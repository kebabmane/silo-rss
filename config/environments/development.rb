...
Rails.application.configure do
  ...
  # Show mailer errors in development for debugging
  ...
  # Open emails in browser using letter_opener
  ...
  # Note: This is set in an initializer to exclude third-party models like SolidQueue
